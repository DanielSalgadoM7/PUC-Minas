...
public class TP2Q16 {
    ...
    public static void main(String args[]) throws Exception {
       ...
       for(int i=0;i<27;i++) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("matricula_insercaoparcial.txt"))) {
    ...
    //ordenação por inserção parcial
    public static void InsercaoParcial(Personagem[] vetor, int pos, int k){
        for(int i = 1; i < pos; i++){
