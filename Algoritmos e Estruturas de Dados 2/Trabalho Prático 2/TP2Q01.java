/*Crie uma classe Personagemgem seguindo todas as regras apresentadas no slide unidade01g_conceitosBasicos_introducaoOO.pdf.
 Sua classe terá os atributos privados id (String), name (String), alternate_names (Lista), house (String), ancestry 
 (String), species (String), patronus (String), hogwartsStaff (Boolean), hogwartsStudent (String), actorName (String), 
 alive (Boolean), dateOfBirth (DateTime), yearOfBirth (int), eyeColour (String), gender (String), hairColour (String), 
 wizard (Boolean). Sua classe também terá pelo menos dois construtores, e os métodos gets, sets, clone, imprimir e ler.

O método imprimir mostra os atributos do registro (ver cada linha da saída padrão) e o ler lê os atributos de um 
registro. Atenção para o arquivo de entrada, pois em alguns registros faltam valores e esse foi substituído pelo valor 
0 (zero) ou vazio.

A entrada padrão é composta por várias linhas e cada uma contém uma string indicando o id do Personagemgem a ser lido. 
...
class Personagem {
    ...
    // Construtores
    Personagem() {
        this("", "", "","", "","", "", false, "", "", false, "",LocalDate.of(1,1,1), 0, "","", "", "");
    }

    Personagem(String id, String nome, String nomeAlternativo,String casa,String ancestry,String especie,String patrono,boolean hogwartsStaff, 
    String hogwartsStudent,String nomeAtor,boolean status,String nomeAtorAlternativo, LocalDate dataNascimento,int anoNascimento,String corOlho, 
    ...
    public void imprimir() {
        System.out.println("[" + this.id + " ## " + this.nome + " ## {" + this.nomeAlternativo + "} ## " + this.casa
                ...
                + " ## " + this.corOlho + " ## " + this.genero + " ## " + this.corCabelo + " ## " + (this.bruxo == "VERDADEIRO" ? "false" : "true") + "]");
    }
            ...
            while ((linha = bufferedReader.readLine()) != null) {
                ...
                try {
                    ...
                    if (id.equals(this.id)) {// O personagem com o ID desejado foi encontrado
                        ...
                        if(campos[17] == "VERDADEIRO"){// verifica se é bruxo
                            this.bruxo = "true";
                        }else{
                            this.bruxo = "false";
                        }
