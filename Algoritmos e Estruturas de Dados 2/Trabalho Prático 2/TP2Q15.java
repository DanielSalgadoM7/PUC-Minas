...
public class TP2Q15 {
    ...
    public static void main(String args[]) throws Exception {
       ...
       for(int i=0;i<27;i++) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("matricula_selecaoparcial.txt"))) {
    ...
    //ordenação por seleção parcial
    public static void SelecaoParcial(Personagem[] vetor, int pos){
        if(pos <= 1){
            return;
        }
