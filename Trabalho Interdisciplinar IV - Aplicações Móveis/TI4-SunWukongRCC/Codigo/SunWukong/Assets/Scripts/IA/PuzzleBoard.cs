...
public class PuzzleBoard : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        statusText.text = "Puzzle já resolvido! Randomize para enfrentar o Boss!";
        numberOfMoves = 0;
        solved = true;
    ...
    IEnumerator Coroutine_Solve()
    {
        ...
        statusText.text = "Buscando soluções através do A*";
    ...
    IEnumerator Coroutine_ShowSolution()
    {
        ...
        statusText.text = "Solução Encontrada! O puzzle vai ser resolvido em: " +
            (reverseSolution.Count - 1).ToString() + " movimentos.";
        ...
        {
            for (int i = reverseSolution.Count - 2; i >= 1; i -= 1)
            {
                numberOfMovesAStar+=1;
        ...
        statusText.text = "Puzzle resolvido! Prepare-se!";
